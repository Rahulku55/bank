        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Banner Tables</h2>
                            ...
                            <div class="card-datatable">
                                <table class="dt-multilingual table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>{{$loop->index+1}}</td>
                                            <td><img src="{{ url('/upload/banner/'.$a->image) }}" style="height: 100px; width: 100px; border-radius: 100%;"></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('banner-delete',[$a->id])}}" class="btn btn-danger" style="border-radius: 100px;"><i data-feather="trash"></i></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    @endforeach
     ...
     <div class="modal-content">
       ...
       <div class="modal-body">
                 ...
                 <div class="col-12 col-md-9">
                     <p class="form-control-static"><img src="{{ url('/upload/banner/'.$a->image) }}" style="height: 200px; width: 200px; border-radius: 100%;"></p>
                 </div>
             </div>
                <div class="row form-group">
