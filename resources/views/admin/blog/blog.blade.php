                                ...
                                <table class="dt-multilingual table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{$a->title}}</td>
                                            <td>{{$a->description}}</td>
                                            <td><img src="{{ url('/upload/blog/'.$a->image) }}" style="height: 100px; width: 100px; border-radius: 100%;"></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('blog-delete',[$a->id])}}" class="btn btn-danger" style="border-radius: 100px;"><i data-feather="trash"></i></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    @endforeach
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <p class="form-control-static">{{$a->description}}</p>
                 ...
                 <div class="col-12 col-md-9">
                     <p class="form-control-static"><img src="{{ url('/upload/blog/'.$a->image) }}" style="height: 200px; width: 200px; border-radius: 100%;"></p>
                 </div>
             </div>
                <div class="row form-group">
